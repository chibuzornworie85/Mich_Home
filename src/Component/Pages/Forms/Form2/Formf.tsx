  ...
  return (
    <>
      ...
      <div className="px-[15px] xl:hidden flex flex-col pt-[30px] pb-[70px] gap-[20px]">
        <div style={{fontFamily: "Satoshi"}} className="font-[900] leading-[130%] text-[20px]">
          <p>Start your search!</p>
        </div>

        <form action="" className="flex flex-col gap-[30px]">
          <div style={{fontFamily: "Poppins"}} className="flex font-[500] leading-[150%] text-[#C7C9D9] flex-col gap-[10px]">
            <label className="text-[#818181] font-[500] leading-[150%]">First Name</label>
            <input type="text" placeholder="Type something" className="text-[#000] rounded-[4px] h-[64px] border-[1px] border-[#DCDFE0] pl-[10px]" />
          </div>
          <div style={{fontFamily: "Poppins"}} className="flex font-[500] leading-[150%] text-[#C7C9D9] flex-col gap-[10px]">
            <label className="text-[#818181] font-[500] leading-[150%]">Last Name</label>
            <input type="text" placeholder="Type something" className="text-[#000] rounded-[4px] h-[64px] border-[1px] border-[#DCDFE0] pl-[10px]" />
          </div>
          <div style={{fontFamily: "Poppins"}} className="flex font-[500] leading-[150%] text-[#C7C9D9] flex-col gap-[10px]">
            <label className="text-[#818181] font-[500] leading-[150%]">Phone Number</label>
            <input type="number" placeholder="Type something" className="text-[#000] rounded-[4px] h-[64px] border-[1px] border-[#DCDFE0] pl-[10px]" />
          </div>
          <div style={{fontFamily: "Poppins"}} className="flex font-[500] leading-[150%] text-[#C7C9D9] flex-col gap-[10px]">
            <label className="text-[#818181] font-[500] leading-[150%]">Email Address</label>
            <input type="email" placeholder="Type something" className="text-[#000] rounded-[4px] h-[64px] border-[1px] border-[#DCDFE0] pl-[10px]" />
          </div>
          <div style={{fontFamily: "Poppins"}} className="flex font-[500] leading-[150%] text-[#C7C9D9] flex-col gap-[10px]">
            <label className="text-[#818181] font-[500] leading-[150%]">How did you hear about us?</label>
          ...
          <div style={{fontFamily: "Poppins"}} className="flex font-[500] leading-[150%] text-[#C7C9D9] flex-col gap-[10px]">
            <label className="text-[#818181] font-[500] leading-[150%]">Any special requests?</label>
            <textarea placeholder="Type something" className="h-[152px] rounded-[4px] border-[1px] text-[#000] border-[#DCDFE0] pl-[10px] py-[10px]"></textarea>
          </div>
