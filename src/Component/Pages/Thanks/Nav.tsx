      ...
      <header className="custom-shadow xl:hidden flex sticky top-0 justify-between items-center px-[15px] bg-[#FFF] h-[80px] rounded-[8px]">
        <div onClick={() => sideDrop(!drop)}>
          {drop ? (
            ...
            <div className="h-[100vh] absolute top-0 left-0 py-[10px] px-[15px] bg-[#FFF] w-[100%]">
        ...
        <div
          style={{ fontFamily: "Poppins" }}
          className="text-[15px] font-[600] rounded-[8px] leading-[150%] text-[#fff] bg-[#000] h-[30px py-[10px] px-[8px] flex justify-center items-center"
        >
