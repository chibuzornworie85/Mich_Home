...
export const Nav: FC = () => {
  ...
  return (
    <>
      {/* Nav */}
      <header className="custom-shadow hidden lg:flex xl:flex justify-between lg:px-[25px] xl:px-[50px] py-[20px] text-center rounded-[8px] bg-[#FFF] items-center sticky top-0">
        <div className="flex items-center xl:gap-[20px] lg:gap-[10px]">
          <Link to="/">
            <img src={logo} alt="logo" className="lg:h-[30px] xl:h-[100%]" />
          </Link>
          <nav style={{ fontFamily: "Poppins" }}>
            <ul className="flex xl:gap-[20px] lg:gap-[10px] items-center text-[#0C1618] text-center text-[15px] font-[500] leading-[170%]">
              <Link to="/apartment">
              ...
              <div
                ...
                className="flex border border-[#0C1618] text-[#0C1618] font-[600] leading-[150%] text-[15px] rounded-[8px] h-[64px px-[10px] py-[10px] items-center xl:gap-[8px]"
              >
                <Link to="/location">
        ...
        >
          <div className="flex items-center xl:gap-[8px]">
            <svg
              width="48"
              height="48"
              viewBox="0 0 48 48"
      ...
      <div className="custom-shadow md:px-[30px] lg:hidden xl:hidden flex sticky top-0 justify-between items-center px-[15px] bg-[#FFF] h-[80px] rounded-[8px]">
        ...
        <div
          style={{ fontFamily: "Poppins" }}
          className="text-[15px] md:text-[20px] font-[600] rounded-[8px] leading-[150%] text-[#fff] bg-[#000] h-[30px py-[10px] px-[8px] flex justify-center items-center"
        >
        ...
        {isOpen && (
          <div
            data-aos="fade-right"
            className="h-[100vh] absolute top-0 md:px-[30px] md:py-[20px] left-0 py-[10px] px-[15px] bg-[#FFF] w-[100%]"
          >
