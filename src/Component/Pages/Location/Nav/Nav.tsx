  ...
  return (
    <>
      ...
      <header className="custom-shadow hidden lg:flex xl:flex justify-between lg:px-[25px] xl:px-[50px] py-[20px] text-center rounded-[8px] bg-[#FFF] items-center sticky top-0">
        <div className="flex items-center xl:gap-[20px] lg:gap-[10px]">
          ...
          <nav style={{ fontFamily: "Poppins" }}>
            <ul className="flex lg:gap-[10px] xl:gap-[20px] items-center text-[#0C1618] text-center text-[15px] font-[500] leading-[170%]">
              <Link to="/apartment">
              ...
              <div
                ...
                className="flex border border-[#0C1618] text-[#0C1618] font-[600] leading-[150%] text-[15px] rounded-[8px] px-[10px] py-[10px] items-center xl:gap-[8px]"
              >
                <Link to="/location">
        ...
        <div
          style={{ fontFamily: "Poppins" }}
          className="flex xl:gap-[10px] items-center lg:gap-[4px]"
        >
      ...
      <div className="custom-shadow lg:hidden xl:hidden flex sticky top-0 justify-between items-center md:px-[30px] px-[15px] bg-[#FFF] h-[80px] rounded-[8px]">
        ...
        <div
          style={{ fontFamily: "Poppins" }}
          className="text-[10px] md:text-[15px] font-[500] rounded-[8px] leading-[150%] text-[#FFF] bg-[#0C1618] h-[30px py-[10px] px-[8px] flex justify-center items-center"
        >
