...
export const Box3: FC = () => {
  return (
    <>
      <div className="px-[100px] flex py-[100px] flex-col gap-[100px]">
        <div className="flex justify-between items-center">
          <div className="flex flex-col gap-[20px]">
            ...
            <p
              ...
              className="text-[#414647] font-[400] leading-[170%] text-[22px] w-[710px]"
            >
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex flex-col gap-[20px]">
            ...
            <p
              style={{ fontFamily: "Poppins" }}
              className="text-[#0C1618] font-[400] leading-[170%] text-[22px] w-[710px]"
            >
