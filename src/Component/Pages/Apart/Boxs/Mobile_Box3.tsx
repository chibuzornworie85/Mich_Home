  ...
  return (
    <>
      <div className="px-[15px] flex flex-col gap-[10px]">
        <div>
          <div className="bg-[url('/src/Component/Assets/Apart_Asset/png(5).png')] bg-no-repeat bg-cover bg-center h-[296px]">
        ...
        <div>
          <div className="bg-[url('/src/Component/Assets/Apart_Asset/png(4).png')] bg-no-repeat bg-cover bg-center h-[296px]">
            <div className="px-[20px] flex justify-between pt-[130px]">
              <div onClick={toggleMenu}>
                <svg
                  width="24"
