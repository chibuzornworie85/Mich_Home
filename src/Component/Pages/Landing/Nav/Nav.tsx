...
export const Nav: FC = () => {
  ...
  return (
    <>
      {/* Nav */}
      <header className="custom-shadow hidden md:hidden lg:flex xl:flex justify-between lg:px-[25px] xl:px-[50px] py-[10px] text-center rounded-[8px] bg-[#FFF] items-center sticky top-0">
